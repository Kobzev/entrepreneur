...
import com.demo.entrepreneur.dto.currency.ArchivedRatesDto;
...
public class DefaultCurrencyService implements CurrencyService {
    ...
    @Autowired
    public DefaultCurrencyService(ExchangeRateRepository rateRepository, Populator<ExchangeRateDto, ExchangeRate> exchangeRatePopulator, RestTemplate restTemplate) {

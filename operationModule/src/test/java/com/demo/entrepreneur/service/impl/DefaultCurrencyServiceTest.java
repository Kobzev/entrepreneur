...
class DefaultCurrencyServiceTest {
    ...
    @Spy
    private ExchangeRatePopulator exchangeRatePopulator = new ExchangeRatePopulator();
    ...
    void whenUrlIsValidAndRestTemplateReturnObject() {
        ...
        verify(exchangeRatePopulator, atLeastOnce()).populateDataToEntity(any(ExchangeRateDto.class), any(ExchangeRate.class));
    ...
    void whenUrlIsInvalid() {
        ...
        verify(restTemplate).getForEntity(anyString(), any());
        verify(exchangeRatePopulator, never()).populateDataToEntity(any(ExchangeRateDto.class), any(ExchangeRate.class));
